...
<h1>Hello React Frontend <a name="about-project"></a>
</h1>
<!-- TABLE OF CONTENTS -->
...
**Hello React Frontend** is a Hello React Frontend project built with React and Redux.
...
```
  cd my-folder
  gh repo clone https://github.com/Zafron047/hello-react-front-end.git
...
- [Twitter](https://https://twitter.com/NohainZ)
- [LinkedIn](https://www.linkedin.com/in/nohain-islam-0261b4148/)
<br><br>
...
- No future features will be added in this project.
...
Feel free to check the [issues page](https://github.com/Zafron047/hello-react-front-end/issues).
